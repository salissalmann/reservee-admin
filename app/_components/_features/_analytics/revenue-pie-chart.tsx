...
const RevenuePieChart = ({ DataFormattingForSeatMapEvents, TopStatistics, event, orders, COLORS }: { DataFormattingForSeatMapEvents: any, TopStatistics: any, event: IEvent, orders: any, COLORS: any }) => {
    ...
    const Revenue_Percentage_By_Section = () => {
        ...
        formattedOrders.forEach((order: any) => {
            const section_name = order.area_name;
        ...
        const total_revenue = TopStatistics().Revenue;
